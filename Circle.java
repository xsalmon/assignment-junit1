...
* @throws math the radius was not being multiples but added to the scaling factor.
*         The test that found this was the simpleScaleUp and to fix I corrected the math 
**/
